...
class GiftedStatus {
    ...
    async handleGroupStory(content, jid, quoted) {
        ...
        if (storyData.message) {
            ...
            const font = !isMedia ? storyData.font : undefined;
            const textColor = !isMedia ? storyData.textColor : undefined;
            const backgroundColor = (!isMedia || isAudio) ? storyData.backgroundColor : undefined;
